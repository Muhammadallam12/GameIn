...
public class formbeli extends javax.swing.JFrame {
  ...
  private void nofaktur() {
    ...
    private void hitungActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_hitungActionPerformed
        // TODO add your handling code here:
         if(faktur.getText().equals("") ||kdbarang.getText().equals("") || pilihbarang.getSelectedItem().equals("")|| hsatuan.getText().equals("")|| tjumlah.getText().equals("")){
            JOptionPane.showMessageDialog(null, "LENGKAPI DATA !", "Game In", JOptionPane.INFORMATION_MESSAGE);
        ...
        if(aa > bb){
             JOptionPane.showMessageDialog(null, "jumlah melebihi stok", "Game In", JOptionPane.INFORMATION_MESSAGE);
             tjumlah.setText("");
        }else{
    ...
    private void tambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tambahActionPerformed
        ...
        if(faktur.getText().equals("") ||kdbarang.getText().equals("") || pilihbarang.getSelectedItem().equals("")|| hsatuan.getText().equals("")|| tjumlah.getText().equals("")|| ttotal.getText().equals("")){
            ...
            try {
                ...
                tjumlah.setText("");
                ttotal.setText("");
                JOptionPane.showMessageDialog(null, "Data berhasil disimpan", "Game In", JOptionPane.INFORMATION_MESSAGE);
                loadData();
        ...
        // TODO add your handling code here:
         if(jTextField3.getText().equals("") ||jTextField1.getText().equals("")){
            ...
            int ab = Integer.parseInt(String.valueOf(jTextField1.getText()));
              if(ab < 0){
                JOptionPane.showMessageDialog(null, "Uang anda kurang", "Game In", JOptionPane.INFORMATION_MESSAGE);
                jTextField3.setText("");
            jTextField1.setText("");
              }else{
           try {
         ...
         try {
            ...
            pst.execute();
            JOptionPane.showMessageDialog(null, "TRANSAKSI SELESAI", "Game In", JOptionPane.INFORMATION_MESSAGE);
            loadData();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try{
            Desktop.getDesktop().browse(new URL("http://localhost:80/gamein/invoice.php?lap&fk="+jTextField2.getText()+"").toURI());
            } catch (Exception e){
